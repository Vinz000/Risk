...
public class MapModel extends Observable {
    ...
    private final List<Player> humanPlayers = new ArrayList<>(NUM_PLAYERS);
    private final List<Player> neutralPlayers = new ArrayList<>(NUM_NEUTRALS);
    ...
    public void changeTurn() {
        currentPlayerIndex++;
        currentPlayerIndex %= NUM_PLAYERS;
    }
