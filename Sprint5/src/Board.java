...
public class Board implements BoardAPI {
    ...
    private final boolean[] occupied = new boolean[GameData.NUM_COUNTRIES];
    private final int[] occupier = new int[GameData.NUM_COUNTRIES];
    private final int[] numUnits = new int[GameData.NUM_COUNTRIES];
    ...
    public int calcReinforcements(Player player) {
        ...
        numUnits = numCountriesOccupied / 3;
        if (numUnits < 3) {
            numUnits = 3;
        }
